...
const aztecfunctions_1 = __importDefault(require("../../functions/treasures-aztec/aztecfunctions"));
// IMPORT LINHAS
const linhaperdaaztec_1 = __importDefault(require("../../jsons/treasures-aztec/linhaperdaaztec"));
const notcashaztec_1 = __importDefault(require("../../jsons/treasures-aztec/notcashaztec"));
const linhaganhoaztec_1 = __importDefault(require("../../jsons/treasures-aztec/linhaganhoaztec"));
const stepsStorage = {};
...
exports.default = {
    ...
    spin(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = req.body.atk;
            try {
                const user = yield aztecfunctions_1.default.getuserbyatk(token);
                let bet = cs * ml * 20;
                ...
                if (checkuserbalance.data.msg === "INVALID_USER" || checkuserbalance.data.msg === "INSUFFICIENT_USER_FUNDS") {
                    res.send(yield notcashaztec_1.default.notcash(saldoatual, cs, ml));
                    return;
                }
                ...
                if (resultadospin.result === "perda") {
                    ...
                    yield aztecfunctions_1.default.attsaldobyatk(token, newbalance);
                    yield aztecfunctions_1.default.atualizardebitado(token, bet);
                    yield aztecfunctions_1.default.atualizarapostado(token, bet);
                    const perdajson = yield linhaperdaaztec_1.default.linhaperda();
                    let json = {
                        dt: {
                            si: {
                                wp: null,
                ...
                if (resultadospin.result === "ganho") {
                    try {
                        ...
                        let linhaGanhoAnterior = yield aztecfunctions_1.default.obterLinhaGanho(userId);
                        ...
                        const ganhojson = yield linhaganhoaztec_1.default.linhaganho(numeroAleatorio);
                        ...
                        yield aztecfunctions_1.default.atualizardebitado(token, bet);
                        yield aztecfunctions_1.default.atualizarapostado(token, bet);
                        yield aztecfunctions_1.default.atualizarganho(token, valorganho);
                        let json = {
                            dt: {
                                si: {
                        ...
                        yield aztecfunctions_1.default.atualizarLinhaGanho(userId, numeroAleatorio);
                        ...
                        if (getSteps(token, gamename) >= Object.keys(ganhojson).length) {
                            ...
                            yield aztecfunctions_1.default.atualizarLinhaGanho(userId, null); // Resetar a linha de ganho quando os steps são resetados
                        }
