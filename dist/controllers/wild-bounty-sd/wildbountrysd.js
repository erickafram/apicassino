...
const bountyfunctions_1 = __importDefault(require("../../functions/wild-bounty-sd/bountyfunctions"));
// IMPORT LINHAS
const linhaperdabouty_1 = __importDefault(require("../../jsons/wild-bounty-sd/linhaperdabouty"));
const notcashbouty_1 = __importDefault(require("../../jsons/wild-bounty-sd/notcashbouty"));
const linhaganhobouty_1 = __importDefault(require("../../jsons/wild-bounty-sd/linhaganhobouty"));
const stepsStorage = {};
...
exports.default = {
    ...
    spin(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = req.body.atk;
            try {
                const user = yield bountyfunctions_1.default.getuserbyatk(token);
                let bet = cs * ml * 20;
                ...
                if (checkuserbalance.data.msg === "INVALID_USER" || checkuserbalance.data.msg === "INSUFFICIENT_USER_FUNDS") {
                    res.send(yield notcashbouty_1.default.notcash(saldoatual, cs, ml));
                    return;
                }
                ...
                if (resultadospin.result === "perda") {
                    ...
                    yield bountyfunctions_1.default.attsaldobyatk(token, newbalance);
                    yield bountyfunctions_1.default.atualizardebitado(token, bet);
                    yield bountyfunctions_1.default.atualizarapostado(token, bet);
                    const perdajson = yield linhaperdabouty_1.default.linhaperda();
                    let json = {
                        dt: {
                            si: {
                                wp: null,
                                ...
                                pcwc: 0,
                                rwsp: null,
                                hashr: "0:7;5;6;5;5;4#2;4;2;8;4;6#6;8;4;9;3;7#9;6;5;9#7;2#MV#12.0#MT#1#MG#0#",
                                fb: null,
                                ml: ml,
                                cs: cs,
                                rl: perdajson.rl,
                                sid: "1839816879486467584",
                                psid: "1839816879486467584",
                                st: 1,
                                nst: 1,
                                pf: 1,
                                aw: 0.0,
                ...
                if (resultadospin.result === "ganho") {
                    try {
                        ...
                        let linhaGanhoAnterior = yield bountyfunctions_1.default.obterLinhaGanho(userId);
                        ...
                        const ganhojson = yield linhaganhobouty_1.default.linhaganho(numeroAleatorio);
                        ...
                        yield bountyfunctions_1.default.atualizardebitado(token, bet);
                        yield bountyfunctions_1.default.atualizarapostado(token, bet);
                        yield bountyfunctions_1.default.atualizarganho(token, valorganho);
                        let json = {
                            dt: {
                                si: {
                                    ...
                                    hashr: "0:7;6;7;9;9;2#2;2;6;8;5;4#6;5;4;9;4;7#4;7;5;8#2;3#R#2#011124#MV#12.0#MT#1#R#6#021021#MV#12.0#MT#1#MG#7.2#",
                                    fb: ganhojson[steps].fb,
                                    ml: ml,
                                    cs: cs,
                                    rl: ganhojson[steps].rl,
                                    sid: "1839816995509304832",
                                    psid: "1839816995509304832",
                        ...
                        yield bountyfunctions_1.default.atualizarLinhaGanho(userId, numeroAleatorio);
                        ...
                        if (getSteps(token, gamename) >= Object.keys(ganhojson).length) {
                            ...
                            yield bountyfunctions_1.default.atualizarLinhaGanho(userId, null); // Resetar a linha de ganho quando os steps são resetados
                        }
