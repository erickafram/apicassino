...
const chickyrunfunctions_1 = __importDefault(require("../../functions/chicky-run/chickyrunfunctions"));
// IMPORT LINHAS
const chickyjson_1 = __importDefault(require("../../jsons/chicky-run/chickyjson"));
const notcashchicky_1 = __importDefault(require("../../jsons/chicky-run/notcashchicky"));
const stepsStorage = {};
...
exports.default = {
    ...
    Play(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = req.body.atk;
            try {
                const user = yield chickyrunfunctions_1.default.getuserbyatk(token);
                let bet = cs * ml * 20;
                ...
                if (checkuserbalance.data.msg === "INVALID_USER" || checkuserbalance.data.msg === "INSUFFICIENT_USER_FUNDS") {
                    res.send(yield notcashchicky_1.default.notcash(saldoatual, cs, ml));
                    return;
                }
                ...
                if (resultadospin.result === "play") {
                    ...
                    yield chickyrunfunctions_1.default.attsaldobyatk(token, newbalance);
                    yield chickyrunfunctions_1.default.atualizardebitado(token, bet);
                    yield chickyrunfunctions_1.default.atualizarapostado(token, bet);
                    const chickyplay = yield chickyjson_1.default.rodadachicky();
                    let json = {
                        dt: {
                            si: {
                                ib: false,
