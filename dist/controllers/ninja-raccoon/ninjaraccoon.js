...
const raccoonfunctions_1 = __importDefault(require("../../functions/ninja-raccoon/raccoonfunctions"));
//IMPORT LINHAS
const linhaperdaraccoon_1 = __importDefault(require("../../jsons/ninja-raccoon/linhaperdaraccoon"));
const linhaganhoraccoon_1 = __importDefault(require("../../jsons/ninja-raccoon/linhaganhoraccoon"));
const notcashraccoon_1 = __importDefault(require("../../jsons/ninja-raccoon/notcashraccoon"));
const stepsStorage = {};
...
exports.default = {
    ...
    spin(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield raccoonfunctions_1.default.getuserbyatk(token);
                let bet = cs * ml * 30;
                console.log(bet);
                ...
                if (checkuserbalance.data.msg === "INVALID_USER") {
                    res.send(yield notcashraccoon_1.default.notcash(saldoatual, cs, ml));
                    return false;
                }
                ...
                if (saldoatual < bet) {
                    const semsaldo = yield notcashraccoon_1.default.notcash(saldoatual, cs, ml);
                    res.send(semsaldo);
                    return false;
                }
                ...
                if (resultadospin.result === "perda") {
                    ...
                    yield raccoonfunctions_1.default.attsaldobyatk(token, newbalance);
                    yield raccoonfunctions_1.default.atualizardebitado(token, bet);
                    yield raccoonfunctions_1.default.atualizarapostado(token, bet);
                    const perdajson = yield linhaperdaraccoon_1.default.linhaperda();
                    let json = {
                        dt: {
                            si: {
                                wp: null,
                ...
                if (resultadospin.result === "ganho") {
                    try {
                        ...
                        let linhaGanhoAnterior = yield raccoonfunctions_1.default.obterLinhaGanho(userId);
                        ...
                        const ganhojson = yield linhaganhoraccoon_1.default.linhaganho(numeroAleatorio);
                        ...
                        yield raccoonfunctions_1.default.atualizardebitado(token, bet);
                        yield raccoonfunctions_1.default.atualizarapostado(token, bet);
                        yield raccoonfunctions_1.default.atualizarganho(token, valorganho);
                        let json = {
                            dt: {
                                si: {
                        ...
                        yield raccoonfunctions_1.default.atualizarLinhaGanho(userId, numeroAleatorio);
                        ...
                        if (getSteps(token, gamename) >= Object.keys(ganhojson).length) {
                            ...
                            yield raccoonfunctions_1.default.atualizarLinhaGanho(userId, null); // Resetar a linha de ganho quando os steps são resetados
                        }
