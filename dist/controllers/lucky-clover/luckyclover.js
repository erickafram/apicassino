...
const luckycloverfunctions_1 = __importDefault(require("../../functions/lucky-clover/luckycloverfunctions"));
// IMPORT LINHAS
const linhaperdaclover_1 = __importDefault(require("../../jsons/lucky-clover/linhaperdaclover"));
const notcashclover_1 = __importDefault(require("../../jsons/lucky-clover/notcashclover"));
const linhaganhoclover_1 = __importDefault(require("../../jsons/lucky-clover/linhaganhoclover"));
const stepsStorage = {};
...
exports.default = {
    ...
    spin(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = req.body.atk;
            try {
                const user = yield luckycloverfunctions_1.default.getuserbyatk(token);
                let bet = cs * ml * 20;
                ...
                if (checkuserbalance.data.msg === "INVALID_USER" || checkuserbalance.data.msg === "INSUFFICIENT_USER_FUNDS") {
                    res.send(yield notcashclover_1.default.notcash(saldoatual, cs, ml));
                    return;
                }
                ...
                if (req.body.fb === "2") {
                    ...
                    yield luckycloverfunctions_1.default.attsaldobyatk(token, saldocompra);
                    logger_1.default.info('[!] COMPRA BONUS ACIONADO COM SUCESSO!');
                }
                if (resultadospin.result === "perda") {
                    let newbalance = saldoatual - bet;
                    yield luckycloverfunctions_1.default.attsaldobyatk(token, newbalance);
                    yield luckycloverfunctions_1.default.atualizardebitado(token, bet);
                    yield luckycloverfunctions_1.default.atualizarapostado(token, bet);
                    const perdajson = yield linhaperdaclover_1.default.linhaperda();
                    let json = {
                        dt: {
                            si: {
                                wp: null,
                ...
                if (resultadospin.result === "ganho") {
                    try {
                        ...
                        let linhaGanhoAnterior = yield luckycloverfunctions_1.default.obterLinhaGanho(userId);
                        ...
                        const ganhojson = yield linhaganhoclover_1.default.linhaganho(numeroAleatorio);
                        ...
                        yield luckycloverfunctions_1.default.atualizardebitado(token, bet);
                        yield luckycloverfunctions_1.default.atualizarapostado(token, bet);
                        yield luckycloverfunctions_1.default.atualizarganho(token, valorganho);
                        let json = {
                            dt: {
                                si: {
                        ...
                        yield luckycloverfunctions_1.default.atualizarLinhaGanho(userId, numeroAleatorio);
                        ...
                        if (getSteps(token, gamename) >= Object.keys(ganhojson).length) {
                            ...
                            yield luckycloverfunctions_1.default.atualizarLinhaGanho(userId, null); // Resetar a linha de ganho quando os steps são resetados
                        }
