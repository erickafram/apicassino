...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE butterflyblossomplayerjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonbutterfly(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM butterflyblossomplayerjson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonbutterfly(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO butterflyblossomplayerjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
