...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE wildapejson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonwildape(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM wildapejson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonwildape(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO wildapejson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
