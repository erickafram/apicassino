...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE chickyrunjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonchicky(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM chickyrunjson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonchicky(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO chickyrunjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
