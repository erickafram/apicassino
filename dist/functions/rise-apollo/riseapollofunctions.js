...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE riseapollojson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonclover(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM riseapollojson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonclover(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO riseapollojson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
