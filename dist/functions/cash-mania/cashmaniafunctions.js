...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE cashmaniaplayerjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsoncash(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM cashmaniaplayerjson WHERE id=?", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
    ...
    createjsoncash(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO cashmaniaplayerjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
};
