...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE fortunetreejson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsontree(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM fortunetreejson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsontree(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO fortunetreejson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
