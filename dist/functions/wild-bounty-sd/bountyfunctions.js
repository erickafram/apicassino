...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE zombieoutbreakjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonzombie(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM zombieoutbreakjson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonzombie(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO zombieoutbreakjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
