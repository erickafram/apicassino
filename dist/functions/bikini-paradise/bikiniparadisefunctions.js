...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE bikineparadisejson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonbikine(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM bikineparadisejson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonbikine(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO bikineparadisejson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
    ...
    updateLastSpin(token, gamename, lastSpinResult) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
      ...
      `;
            yield database_1.default.query(query, [token, gamename, lastSpinResult]);
        });
    },
    attawcall(id, valor) {
        return __awaiter(this, void 0, void 0, function* () {
