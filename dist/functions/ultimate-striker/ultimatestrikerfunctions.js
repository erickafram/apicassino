...
exports.default = {
    getuserbytoken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query(`SELECT * FROM users WHERE token= ?`, [
                token,
            ]);
            return res[0];
        });
    ...
    getuserbyatk(atk) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query(`SELECT * FROM users WHERE atk= ?`, [
                atk,
            ]);
            return res[0];
        });
    ...
    getcall(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM calls WHERE iduser = ?", [
                id,
            ]);
            return res[0];
        });
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE ultimatestrikerjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonstriker(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM ultimatestrikerjson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonstriker(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO ultimatestrikerjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    getcallbyid(id) {
    ...
    atualizarLinhaGanho(userId, linhaGanho) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE users SET linha_ganho = ? WHERE id = ?", [linhaGanho, userId]);
            return res[0];
        });
    },
    obterLinhaGanho(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT linha_ganho FROM users WHERE id = ?", [userId]);
