...
# =====================================================
# SCRIPT DE DEPLOY - SERVIDOR COM NODE.JS EXISTENTE
# =====================================================
# Para servidores que já têm Node.js 22 LTS configurado
# Porta padrão: 3000
# =====================================================
...
|_|    \____| |____/ \___/|_|     |_|/_/   \_\_|  |___|
    ...
    DEPLOY PARA SERVIDOR COM NODE.JS EXISTENTE
EOF
echo -e "${NC}"
...
if ! command -v node &> /dev/null; then
    error "Node.js não encontrado. Este script é para servidores que já têm Node.js instalado."
fi
...
info "Domínio: $DOMAIN"
info "Email: $EMAIL"
info "Porta da API: $API_PORT (Node.js $NODE_VERSION)"
...
log "Verificando/Instalando PM2..."
...
log "Verificando/Instalando Nginx..."
...
log "Verificando/Instalando Certbot..."
...
if [ ! -f "package.json" ]; then
    error "Arquivo package.json não encontrado. Execute este script no diretório do projeto."
fi
...
info "🔧 Porta: $API_PORT (Node.js $NODE_VERSION)"
info "📁 Diretório: $PROJECT_DIR"
...
warning "2. Execute: mysql -u $DB_USER -p $DB_NAME < pgapi_complete_database.sql"
warning "3. Execute: mysql -u $DB_USER -p $DB_NAME < database_migration_cassino_compatibility.sql"
warning "4. Teste a API: curl https://$DOMAIN/health"
echo ""
